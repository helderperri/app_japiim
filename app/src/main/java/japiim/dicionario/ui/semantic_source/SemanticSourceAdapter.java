...
public class SemanticSourceAdapter extends RecyclerView.Adapter<SemanticSourceAdapter.ViewHolder> {
    ...
    public SemanticSourceAdapter(List<GetEntriesSdsTableValues> semanticDomainsList){
