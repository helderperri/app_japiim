...
import japiim.dicionario.GetPhonemicsTableValues;
...
public class DatabasePhonemicsAdapter {
    ...
    public List<GetPhonemicsTableValues> getPhonemics(){
        ...
        while(cursor.moveToNext()){
            ...
            GetPhonemicsTableValues getPhonemicsTableValues = new GetPhonemicsTableValues(formId, entryRef, phonemicId, phonemic);
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String CREATE_TABLE = "create table "+ TABLE_NAME+
                " ("+ KEY_FORMID+" integer, " + KEY_ENTRYREF+ " text, "+ KEY_PHONEMICID + " integer primary key autoincrement, " + KEY_PHONEMIC + " text)";
