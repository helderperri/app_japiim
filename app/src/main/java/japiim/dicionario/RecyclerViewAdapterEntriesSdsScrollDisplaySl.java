...
public class RecyclerViewAdapterEntriesSdsScrollDisplaySl extends RecyclerView.Adapter<RecyclerViewAdapterEntriesSdsScrollDisplaySl.ViewHolder> {
    ...
    public RecyclerViewAdapterEntriesSdsScrollDisplaySl(Context context, List<GetEntriesVernacularSdsTableValues> entriesVernacularList, RecyclerView rvEntriesScrollDisplaySl){
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterEntriesSdsScrollDisplaySl.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterEntriesSdsScrollDisplaySl.ViewHolder viewHolder, int i) {
        GetEntriesVernacularSdsTableValues entryVernacular = entriesVernacularList.get(i);
  
        viewHolder.rowVernacular.setText(""+entryVernacular.getVernacular());
   
        entryBundleId = entryVernacular.getEntryBundleId();
        senseBundleId = entryVernacular.getSenseBundleId();

        databaseEntriesDefsAdapter = new DatabaseEntriesDefsAdapter(context, entryBundleId,senseBundleId, 0);
        entriesDefsList = databaseEntriesDefsAdapter.getEntriesDefsBySenseBundle(senseBundleId);
